...
public interface UserAccountRepository extends JpaRepository<UserAccount, Long> {
    ...
    @Query("SELECT new net.askvio.controllers.account.dto.UserResponse(account.id, account.firstname, account.lastname, account.username, account.email, account.activated, account.creationDate) FROM UserAccount account WHERE account.id = :id")
